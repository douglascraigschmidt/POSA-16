 ...
 * by the GenericPresenter framework.  This class plays the role of
 * the "Abstraction" in the Bridge pattern to decouple the interface
 * of the Model layer from the particular type of Service used to
...
public class ImageModel
    ...
    public void onCreate(MVP.RequiredPresenterOps presenter) {
        ...
        // Create a STARTED_SERVICE by default.
